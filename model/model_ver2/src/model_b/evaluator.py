...
class RealBService:
    ...
    def __init__(
        ...
        discriminator_mode: str = ORIGINAL_CODE2,
    ) -> None:
        ...
        try:
            ...
            original_discriminator = OriginalCode2Discriminator.load(self.root)
        ...
        self.discriminator = (
            ScopeAlignedExperimentalDiscriminator(alpha=original_discriminator.alpha)
    ...
    def run_b_simulation(
        ...
        return {
            ...
            "warnings": (
                ...
                if self.discriminator_mode == SCOPE_ALIGNED_EXPERIMENTAL
                else list(self.original_discriminator.warnings)
            ),
        }
    ...
    def _ensure_scope_aligned_threshold(
        ...
        original_rule = evaluate_baseline(rule_policy_matrix().astype(np.float32))
    ...
    def run_policy_discriminator(
        ...
        for key in (
            ...
            "baseline_profit", "baseline_profit_sign",
        ):
            if key in raw:
                result[key] = raw[key]
        return result
