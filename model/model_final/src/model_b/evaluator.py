...
from .experimental_discriminator import (
...
class RealBService:
    ...
    def __init__(
        ...
        try:
            bundle = load_b_artifacts(
                self.root / "artifacts" / "b_runtime",
                resolve_data_dir(self.root, data_dir),
            )
        ...
        self.discriminator = ScopeAlignedExperimentalDiscriminator()
    ...
    def run_b_simulation(
        ...
        return {
            ...
            "simulation_artifact_source": "B_RUNTIME_ARTIFACTS",
            ...
            "warnings": ["EXPERIMENTAL_SCOPE_ALIGNED_THRESHOLD_ENABLED"],
        }
    ...
    def run_policy_discriminator(
        ...
        """Run the scope-aligned operational B discriminator."""
