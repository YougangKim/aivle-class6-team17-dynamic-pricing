...
CURRENT_B_MODEL_VERSION = EXPERIMENTAL_B_MODEL_VERSION
...
class RealPolicyReplayBuffer:
    ...
    def save(self, artifact_dir: str | Path):
        ...
        pd.DataFrame(rows).to_csv(
            out / "replay_metadata.csv", index=False, encoding="utf-8-sig"
        )
        return out
    ...
    def load(cls, artifact_dir: str | Path, minimum_size=6, capacity=2000, seed=42):
        ...
        metadata = pd.read_csv(root / "replay_metadata.csv")
