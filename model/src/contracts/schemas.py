...
from src.contracts.b_modes import ORIGINAL_CODE2, SUPPORTED_DISCRIMINATOR_MODES
...
def validate_runtime_request(request: Mapping[str, Any]) -> dict[str, Any]:
    ...
    for key in ("policy_tolerance", "objective_tolerance", "objective_relative_tolerance", "objective_epsilon", "max_runtime_seconds"):
